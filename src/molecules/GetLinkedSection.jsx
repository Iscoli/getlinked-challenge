...
import MetricLogo from "../assets/metrix.png";
...
import { useRef } from "react";
  ...
  return (
    <>
      ...
      <section className={styles.getLinkSection}>
        ...
        <div style={{ position: "relative" }} className={styles.getLink}>
          ...
          <p className={styles.participate}>
            Participate in getlinked tech Hackathon 2023  <br></br> stand a chance to win a
            Big prize
          </p>
      ...
      <img className={`${styles.rotatingImage } ${styles.water}`}
      src={water} alt="Rotating Image" />
         </div>
          <img
